<div class="app-sidebar__overlay" data-toggle="sidebar"></div>
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"style="background: black;"><a class="app-menu__item" href="{{url('admin/admin')}}" 
        data-toggle="treeview"><i class="app-menu__icon fa fa-envelope"></i><span class="app-menu__label">Admin</span><i class="treeview-indicator fa fa-angle-right"></i></a>
