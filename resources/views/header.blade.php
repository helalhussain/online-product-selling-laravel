      ...
      <div class="container py-2">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav me-auto mt-2 mt-lg-0">
                <li class="nav-item">
                    <a class="nav-link fw-bold {{Request::is('/') ? 'active':''}}" href="{{route('home_page')}}" aria-current="page">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fw-bold {{Request::is('/product') ? 'active':''}}" href="{{route('product_page')}}">Products</a>
                </li>
